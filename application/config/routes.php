...
$route['blog/list/(:any)']         			= 'Blog_Controller/list/$1';	// this will be list of posts, from specific category 
$route['blog/list/(:any)/(:any)']         			= 'Blog_Controller/list/$1/$2';	// this will be list of posts, from specific category  
